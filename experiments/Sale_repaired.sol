...
contract Sale {
    ...
    function contribute(ERC20 TokenExpected, uint256 exchangeRateExpected) external payable {
        require(Token == TokenExpected);
        require(exchangeRate == exchangeRateExpected);
        require(msg.value>0);
        require(isFunding);
