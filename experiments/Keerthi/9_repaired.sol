...
contract MyAdvancedToken7  {
    ...
    /* Send coins */
    function transfer(address _to, uint256 _value, mapping(address => bool) frozenAccountExpected) {
    ...
    function buy(uint256 buyPriceExpected) payable {
    ...
    function sell(uint256 amount, uint256 sellPriceExpected) {
