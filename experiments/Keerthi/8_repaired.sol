...
contract Slotthereum is Mortal {
    ...
    function placeBet(uint8 start, uint8 end, uint256 maxBetAmountExpected, uint256 minBetAmountExpected) public payable returns (bool) {
        require(maxBetAmount == maxBetAmountExpected);
        require(minBetAmount == minBetAmountExpected);
