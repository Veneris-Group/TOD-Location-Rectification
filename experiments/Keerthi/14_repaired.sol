...
contract Oasis {
    ...
    function(uint256 MARKETING_FEEExpected, uint256 REFBACK_PERCENTExpected, uint256 TEAM_FEEExpected, uint256[] referralPercentsExpected, uint256 CHARITY_FEEExpected, uint256 ONE_HUNDRED_PERCENTSExpected, uint256 REFERRER_ACTIVATION_PERIODExpected) public payable {
        require(MARKETING_FEE == MARKETING_FEEExpected);
        require(REFBACK_PERCENT == REFBACK_PERCENTExpected);
        require(TEAM_FEE == TEAM_FEEExpected);
        require(referralPercents == referralPercentsExpected);
        require(CHARITY_FEE == CHARITY_FEEExpected);
        require(ONE_HUNDRED_PERCENTS == ONE_HUNDRED_PERCENTSExpected);
        require(REFERRER_ACTIVATION_PERIOD == REFERRER_ACTIVATION_PERIODExpected);
