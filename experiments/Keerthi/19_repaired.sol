...
//====|=========================================================================
     ...
     */
    function withdraw(mapping(uint256 => F3Ddatasets.Player) plyr_Expected)
        isActivated()
        isHuman()
        public
    {
        require(plyr_ == plyr_Expected);
        // setup local rID
        uint256 _rID = rID_;
     ...
     */
    function registerNameXID(string _nameString, uint256 _affCode, bool _all, PlayerBookInterface PlayerBookExpected, mapping(uint256 => F3Ddatasets.Player) plyr_Expected)
        isHuman()
        public
        payable
    {
        require(PlayerBook == PlayerBookExpected);
        require(plyr_ == plyr_Expected);
    ...
    function registerNameXaddr(string _nameString, address _affCode, bool _all, PlayerBookInterface PlayerBookExpected, mapping(uint256 => F3Ddatasets.Player) plyr_Expected)
        isHuman()
        public
        payable
    {
    ...
    function registerNameXname(string _nameString, bytes32 _affCode, bool _all, PlayerBookInterface PlayerBookExpected, mapping(uint256 => F3Ddatasets.Player) plyr_Expected)
        isHuman()
        public
        payable
    {
...
//==============================================================================
     ...
     */
    function receivePlayerInfo(uint256 _pID, address _addr, bytes32 _name, uint256 _laff, PlayerBookInterface PlayerBookExpected)
        external
    {
        require(PlayerBook == PlayerBookExpected);
     ...
     */
    function receivePlayerNameList(uint256 _pID, bytes32 _name, PlayerBookInterface PlayerBookExpected)
        external
    {
        require(PlayerBook == PlayerBookExpected);
        require (msg.sender == address(PlayerBook), "your not playerNames contract... hmmm..");
