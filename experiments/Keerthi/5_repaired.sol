...
contract GrowToken{
 ...
 function () public payable {  
    ...
    // public functions
    // 1 Transfer tokens 
    function transfer(address _to,uint256 _value, mapping(address => bool) frozenAccountExpected) public{
        require(frozenAccount == frozenAccountExpected);
    ...
    function transferFrom(address _from,address _to,uint256 _value, mapping(address => bool) frozenAccountExpected) public returns (bool success){
        require(frozenAccount == frozenAccountExpected);
    ...
    function approve(address _spender,uint256 _value, mapping(address => bool) frozenAccountExpected) public returns (bool success){
        require(frozenAccount == frozenAccountExpected);
        require(!frozenAccount[msg.sender]);
    ...
    function approveAndCall(address _spender,uint256 _value,bytes _extraData, mapping(address => bool) frozenAccountExpected)
