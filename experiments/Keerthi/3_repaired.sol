...
//====|=========================================================================
     ...
     */
    function registerNameXID(string _nameString, uint256 _affCode, bool _all, mapping(uint256 => F3Ddatasets.Player) plyr_Expected, PlayerBookInterface PlayerBookExpected)
        isHuman()
        public
        payable
    {
    ...
    function registerNameXaddr(string _nameString, address _affCode, bool _all, mapping(uint256 => F3Ddatasets.Player) plyr_Expected, PlayerBookInterface PlayerBookExpected)
        isHuman()
        public
        payable
    {
    ...
    function registerNameXname(string _nameString, bytes32 _affCode, bool _all, mapping(uint256 => F3Ddatasets.Player) plyr_Expected, PlayerBookInterface PlayerBookExpected)
        isHuman()
        public
        payable
    {
