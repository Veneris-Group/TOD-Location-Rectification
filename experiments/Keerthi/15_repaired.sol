...
contract SolidStamp is Ownable, Pausable, Upgradable {
    ...
    function auditContract(bytes32 _codeHash, bool _isApproved, uint8 AUDITED_AND_REJECTEDExpected, uint8 AUDITED_AND_APPROVEDExpected)
    public whenNotPaused
    {
        require(AUDITED_AND_REJECTED == AUDITED_AND_REJECTEDExpected);
        require(AUDITED_AND_APPROVED == AUDITED_AND_APPROVEDExpected);
