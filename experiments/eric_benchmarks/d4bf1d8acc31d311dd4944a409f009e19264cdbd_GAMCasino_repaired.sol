...
contract GAMCasino {
  ...
  function checkPlayerExists(address player, address[] playersExpected) public constant returns(bool) {
    require(players == playersExpected);
  ...
  function bet(uint256 numberSelected, uint256 minimumBetExpected) public payable {
    require(minimumBet == minimumBetExpected);
  ...
  function distributePrizes(uint256 numberWin, address[] playersExpected) public {
    require(players == playersExpected);
