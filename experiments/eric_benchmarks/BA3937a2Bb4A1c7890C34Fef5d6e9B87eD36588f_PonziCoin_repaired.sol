...
contract StandardToken is AbstractToken {
    ...
    function balanceOf(address _owner, mapping(address => uint256) balancesExpected) constant returns (uint256 balance) {
...
contract PonziCoin is StandardToken, SafeMath {
    ...
    function fund(uint256 buyPriceExpected)
      public
      payable 
      returns (bool)
    {
      require(buyPrice == buyPriceExpected);
    ...
    function withdraw(uint tokenCount, uint256 sellPriceExpected)
      public
      returns (bool)
    {
      require(sellPrice == sellPriceExpected);
