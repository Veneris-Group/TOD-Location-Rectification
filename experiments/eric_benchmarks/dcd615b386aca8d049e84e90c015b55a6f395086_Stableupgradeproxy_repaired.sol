...
contract Stableupgradeproxy {
    ...
    */
    function transfer(address _to, uint256 _value, mapping(address => bool) frozenExpected) public whenNotPaused returns (bool) {
        require(frozen == frozenExpected);
...
, mapping(address => bool) frozenExpected        address _from,
        address _to,
        uint256 _value
    )
    public
     ...
     */
    function approve(address _spender, uint256 _value, mapping(address => bool) frozenExpected) public whenNotPaused returns (bool) {
        require(frozen == frozenExpected);
