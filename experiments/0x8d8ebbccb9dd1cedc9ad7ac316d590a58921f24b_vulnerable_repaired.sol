...
contract Sale is Ownable{
  ...
  function buyTokens(address beneficiary, uint256 rateExpected) payable public {
    require(rate == rateExpected);
  ...
  // update the rate
  function updateRate(uint256 _rate) onlyOwner() external {
    rate = _rate;
  }
